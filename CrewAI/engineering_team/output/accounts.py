...
class Account:
    ...
    def deposit(self, amount: float) -> None:
        ...
        self.balance += amount
        self._record_transaction(transaction_type="deposit", symbol="", quantity=0, price=amount)
    ...
    def withdraw(self, amount: float) -> None:
        ...
        self.balance -= amount
        self._record_transaction(transaction_type="withdrawal", symbol="", quantity=0, price=amount)
